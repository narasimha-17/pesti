...
export const api = {
  ...
  orders: () => call('/orders'),
  adminProducts: () => call('/admin/products'),
  adminCreateProduct: (body) => call('/admin/products', body),
  adminUpdateProduct: (slug, body) => call(`/admin/products/${slug}`, body, 'PATCH'),
  adminDeleteProduct: (slug) => call(`/admin/products/${slug}`, undefined, 'DELETE'),
  adminUpdateStock: (slug, sku, stock) => call(`/admin/products/${slug}/variants/${sku}/stock`, { stock }, 'PATCH'),
  adminUsers: () => call('/admin/users'),
  adminSetRole: (id, role) => call(`/admin/users/${id}/role`, { role }, 'PATCH'),
  adminLogs: () => call('/admin/logs'),
  adminCoupons: () => call('/admin/coupons'),
  adminCreateCoupon: (body) => call('/admin/coupons', body),
  adminUpdateCoupon: (id, body) => call(`/admin/coupons/${id}`, body, 'PATCH'),
  adminDeleteCoupon: (id) => call(`/admin/coupons/${id}`, undefined, 'DELETE'),
  visitRequest: (body) => call('/visit-requests', body),
  myVisitRequests: () => call('/visit-requests'),
  adminVisitRequests: () => call('/admin/visit-requests'),
  adminUpdateVisitStatus: (id, status) => call(`/admin/visit-requests/${id}`, { status }, 'PATCH'),
  products(f = {}) {
